...
public class TestNoise extends SimpleApplication{
    ...
    public void simpleInitApp(){
        ...
        BlockTerrainControl blockTerrain = new BlockTerrainControl(CubesTestAssets.getSettings(this), new Vector3Int(8, 1, 8));
        blockTerrain.setBlocksFromNoise(new Vector3Int(0, 0, 0), new Vector3Int(128, 20, 128), 0.3f, CubesTestAssets.BLOCK_GRASS);
