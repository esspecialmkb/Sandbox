...
public class TestBlockModel extends SimpleApplication{
    ...
    public void simpleInitApp(){
        ...
        BlockTerrainControl blockTerrain = new BlockTerrainControl(CubesTestAssets.getSettings(this), new Vector3Int(16, 1, 16));
        new BlockModel("Models/Map.j3o", new Block[]{CubesTestAssets.BLOCK_GRASS}).addToBlockTerrain(blockTerrain, new Vector3Int(), new Vector3Int(256, 35, 256));
