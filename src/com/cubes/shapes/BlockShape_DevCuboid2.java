 ...
 * @author Carl 
 */
public class BlockShape_DevCuboid2 extends BlockShape{

    public BlockShape_DevCuboid2(float[] extents, float[] extents2, float[] extents3){
        this.extents = extents;
        this.extents2 = extents2;
        this.extents3 = extents3;
    }
    //{top, bottom, left, right, front, back}
    private float[] extents;
    private float[] extents2;
    private float[] extents3;
    public boolean dualShape = false;

    /**
     *  We are refactoring the code used for adding the block's geometry
     * to the chunk mesh/spatial
     * @param chunk
     * @param blockLocation
     */
    @Override
    public void addTo(BlockChunkControl chunk, Vector3Int blockLocation){
        ...
        //Create the first part of the geometry from extents array
        ...
        //A negative float in the second array will disable generation of the secondary cubiod shape
        if(extents2[0] > 0.0f){
            //Create the second part of the geometry from extents array
            faceLoc_Bottom_TopLeft = blockLocation3f.add(new Vector3f((0.5f - extents2[2]), (0.5f - extents2[1]), (0.5f - extents2[5])));
            faceLoc_Bottom_TopRight = blockLocation3f.add(new Vector3f((0.5f + extents2[3]), (0.5f - extents2[1]), (0.5f - extents2[5])));
            faceLoc_Bottom_BottomLeft = blockLocation3f.add(new Vector3f((0.5f - extents2[2]), (0.5f - extents2[1]), (0.5f + extents2[4])));
            faceLoc_Bottom_BottomRight = blockLocation3f.add(new Vector3f((0.5f + extents2[3]), (0.5f - extents2[1]), (0.5f + extents2[4])));

            faceLoc_Top_TopLeft = blockLocation3f.add(new Vector3f((0.5f - extents2[2]), (0.5f + extents2[0]), (0.5f - extents2[5])));
            faceLoc_Top_TopRight = blockLocation3f.add(new Vector3f((0.5f + extents2[3]), (0.5f + extents2[0]), (0.5f - extents2[5])));
            faceLoc_Top_BottomLeft = blockLocation3f.add(new Vector3f((0.5f - extents2[2]), (0.5f + extents2[0]), (0.5f + extents2[4])));
            faceLoc_Top_BottomRight = blockLocation3f.add(new Vector3f((0.5f + extents2[3]), (0.5f + extents2[0]), (0.5f + extents2[4])));
        ...
        //Create the third cubiod shape
        if(extents3[0] > 0.0f){
            //Create the second part of the geometry from extents array
            faceLoc_Bottom_TopLeft = blockLocation3f.add(new Vector3f((0.5f - extents3[2]), (0.5f - extents3[1]), (0.5f - extents3[5])));
            faceLoc_Bottom_TopRight = blockLocation3f.add(new Vector3f((0.5f + extents3[3]), (0.5f - extents3[1]), (0.5f - extents3[5])));
            faceLoc_Bottom_BottomLeft = blockLocation3f.add(new Vector3f((0.5f - extents3[2]), (0.5f - extents3[1]), (0.5f + extents3[4])));
            faceLoc_Bottom_BottomRight = blockLocation3f.add(new Vector3f((0.5f + extents3[3]), (0.5f - extents3[1]), (0.5f + extents3[4])));

            faceLoc_Top_TopLeft = blockLocation3f.add(new Vector3f((0.5f - extents3[2]), (0.5f + extents3[0]), (0.5f - extents3[5])));
            faceLoc_Top_TopRight = blockLocation3f.add(new Vector3f((0.5f + extents3[3]), (0.5f + extents3[0]), (0.5f - extents3[5])));
            faceLoc_Top_BottomLeft = blockLocation3f.add(new Vector3f((0.5f - extents3[2]), (0.5f + extents3[0]), (0.5f + extents3[4])));
            faceLoc_Top_BottomRight = blockLocation3f.add(new Vector3f((0.5f + extents3[3]), (0.5f + extents3[0]), (0.5f + extents3[4])));
